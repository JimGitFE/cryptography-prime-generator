...
const polynomial_1 = __importDefault(require("polynomial"));
let t = new polynomial_1.default("x^10+x^3+1");
console.log(t.gcd("x^32-x"));
...
return true
*/
function isIrreducible(polynomial, n) {
    for (let i = 1; i <= n / 2; i++) {
...
// 2024
const expToCoefs = ({ dividend, divisor }) => {
...
console.log((0, division_1.dividePolynomials)(expToCoefs({ dividend: [1024, -1], divisor: [10, 3, 0] })));
console.log((0, division_1.polyMod)(expToCoefs({ dividend: [1024, -1], divisor: [10, 3, 0] })));
